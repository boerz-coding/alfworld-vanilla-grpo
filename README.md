...
- 训练数据:ALFWorld **json_2.1.1** train split 的固定子集(2162/2435 任务目录,约标准 train 的 89%),由 `selfevolve/make_scene_holdout.py` + 冻结清单 `selfevolve/scene_holdout_manifest.frozen.json` 构造;参考曲线的三次训练均出自该子集。评测集不受影响:valid_seen 全量 140 局。
