...
> "verl 参数"是我们框架的原始写法;"语义"栏供翻译到贵侧框架。**语义等效优先于名字相同**。
...
| env seed | `env.seed` | 0 / 1 / 2 | 参考曲线三次训练分别用的种子;您可任选其一并注明 |
...
- 本表与产出参考曲线的训练脚本逐行核对过;若贵侧框架有对不上的语义,烦请在 diff 清单中注明即可;评测侧请保持原样以确保可比。
